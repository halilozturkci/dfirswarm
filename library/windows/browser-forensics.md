...
- Extract what you need into `work/extracted/<your id>/` (quarantined:
  ...
  record is missed; a peer may find `browser_history` already seeded. Every
...
least 18 dated rows built from the ledger, `work/browsing.md` holds the
per-browser activity as a table with at least one row of substance, the
